 ...
 */
package com.googlecode.aluminumproject.parsers.test;
...
/**
 * A parser that will be ignored when all parsers in a package are added.
 *
 * @author levi_h
 */
@Ignored
public class IgnoredParser implements Parser {
	/**
	 * Creates an ignored parser.
	 */
