...
public class AluScriptTemplateNameTranslatorTest {
	private TemplateNameTranslator translator;

	@BeforeMethod
	public void createTranslator() {
		translator = new AluScriptTemplateNameTranslator();
	}

	public void actionNameShouldBeKeptAsIs() {
	...
	public void actionParameterNameShouldBeKeptAsIs() {
	...
	public void actionContributionNameShouldBeKeptAsIs() {
