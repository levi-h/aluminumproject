...
public class WarnTest extends LoggingLibraryTest {
	public void messageShouldBeLogged() {
		processTemplate("warn");

		List<ILoggingEvent> loggingEvents = getLoggingEvents("warn");
	...
	public void bodyMessageShouldBeLogged() {
		processTemplate("warn-with-body");

		List<ILoggingEvent> loggingEvents = getLoggingEvents("warn-with-body");
		assert loggingEvents.size() == 1;
