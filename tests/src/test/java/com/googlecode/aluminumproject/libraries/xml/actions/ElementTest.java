...
public class ElementTest extends XmlLibraryTest {
	public void singleElementShouldResultInDocument() {
		assert processTemplate("element").equals(createXml("<document/>"));
	}

	public void elementsShouldBeNestable() {
		assert processTemplate("elements-nested").equals(createXml(
			"<document>",
			"    <page/>",
			"</document>"
		));
