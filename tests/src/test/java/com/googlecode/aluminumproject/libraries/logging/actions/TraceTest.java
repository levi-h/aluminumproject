...
public class TraceTest extends LoggingLibraryTest {
	public void messageShouldBeLogged() {
		processTemplate("trace");

		List<ILoggingEvent> loggingEvents = getLoggingEvents("trace");
	...
	public void bodyMessageShouldBeLogged() {
		processTemplate("trace-with-body");

		List<ILoggingEvent> loggingEvents = getLoggingEvents("trace-with-body");
		assert loggingEvents.size() == 1;
