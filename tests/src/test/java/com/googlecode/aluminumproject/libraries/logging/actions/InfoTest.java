...
public class InfoTest extends LoggingLibraryTest {
	public void messageShouldBeLogged() {
		processTemplate("info");

		List<ILoggingEvent> loggingEvents = getLoggingEvents("info");
	...
	public void bodyMessageShouldBeLogged() {
		processTemplate("info-with-body");

		List<ILoggingEvent> loggingEvents = getLoggingEvents("info-with-body");
		assert loggingEvents.size() == 1;
