...
/**
 * Minimises the effort it takes to implement {@link TemplateElement the template element interface}.
 *
 * @author levi_h
 */
public abstract class AbstractTemplateElement implements TemplateElement {
	 ...
	 *
	 * @param libraryUrlAbbreviations the template element's library URL abbreviations
	 */
	protected AbstractTemplateElement(Map<String, String> libraryUrlAbbreviations) {
