...
public interface Action {
	 ...
	 * @throws ActionException when the action can't be executed
	 ...
	 */
	void execute(Context context, Writer writer) throws ActionException, ContextException, WriterException;
}